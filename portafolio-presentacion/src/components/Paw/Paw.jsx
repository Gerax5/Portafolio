...
const Paw = React.forwardRef(({istranslate, rotate, height, left, top, seconds}, ref) => {
    ...
    return (
        <div style={{backgroundColor:'black', display:'flex', flexDirection:'column', height: height ? height: "80%", width:"10%", alignSelf:'center', bottom:0, position:'absolute', transform: istranslate ? rotate: handPosition, transition:`transform ${seconds}s ease-in-out`, borderRadius: "25% 25% 0 0", marginLeft:left ? left : 0, top:top ? top : 0}}>
